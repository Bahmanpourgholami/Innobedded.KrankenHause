...
{
  public  class InsurenceRepository:GenericRepositoy<Insurance>,IInsurenceRepository
    {

        public InsurenceRepository(KrankenHausDbContext dbContext):base(dbContext)
        {
