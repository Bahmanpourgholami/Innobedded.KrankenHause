...
{
  public  class ReceptionRepository:GenericRepositoy<Reception>, IReceptionRepository
    {
        public ReceptionRepository(KrankenHausDbContext dbContext):base(dbContext)
        {
