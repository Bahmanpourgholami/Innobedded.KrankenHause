...
{
 public   class AppointmentRepository:GenericRepositoy<Appointment>, IAppointmentRepository
    {
        public AppointmentRepository(KrankenHausDbContext dbContext):base(dbContext)
        {
